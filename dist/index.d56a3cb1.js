...
const chart1 = new _chart.Chart(_ibmJson);
chart1.drawChart();
...
},{"../data/ibm.json":"katCd","./chart":"imxe8"}],"katCd":[function(require,module,exports) {
...
},{}],"imxe8":[function(require,module,exports) {
...
class Chart {
    ...
    transformData() {
        this.data = this.data.map((price)=>{
            price.sortDate = new Date(price.Date);
            return price;
        });
        this.data = this.data.sort((a, b)=>b.sortDate - a.sortDate
        );
    ...
    calculateAverages() {
        this.data.forEach((day, idx)=>{
            ...
            const dayRange = this.data.slice(start, idx).map((x)=>x.Close
            );
            let total;
    ...
    drawYAxis() {
        ...
        const min = Math.floor(Math.min(...closingValues));
    ...
    drawPoints() {
        ...
        this.data.forEach((day, idx)=>{
            this.ctx.beginPath();
            this.ctx.arc(idx * factor + 100, this.getYPoint(day.movingAvg), 2, 0, Math.PI * 2);
            this.ctx.stroke();
        });
    }
    getYPoint(value) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./models/constants":"hTtwU"}],"ciiiV":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["1Mq12","5HwUs"], "5HwUs", "parcelRequirec86a")
